...
export default function Header() {
  ...
  return (
    <header>
      <nav className="flex justify-between items-center h-12 px-4 shadow-md bg-violet-800 text-white">
        <Link href="/" className="text-lg font-bold">
          My Anime Figure Shop
        </Link>
        <SignedIn>
        ...
        <Link href="/historia" className="text-lg font-bold">
            purchase history 
          </Link>
        </SignedIn>
        <div >
